      ...
      >
        <div>
          ...
          <p className="mt-8" style={bodyStyle}>
            Nous vous aidons à identifier les pertes invisibles et les leviers d&apos;amélioration
            les plus rapides à mettre en place.
          </p>
          ...
          >
            ...
            <ul
              className="mt-3 flex flex-wrap gap-x-10 gap-y-2"
              style={{
                listStyle: 'none',
                padding: 0,
                margin: '12px 0 0',
          ...
          <p className="mt-8" style={bodyStyle}>
            Ce premier échange sert à comprendre comment le travail circule aujourd&apos;hui : qui
            saisit quoi, où l&apos;information s&apos;arrête, et ce qui force les équipes à
            ...
            n&apos;est pas un projet informatique : c&apos;est de rendre une opération plus fluide,
            plus visible et plus simple à tenir dans le temps.
          </p>

          <div className="mt-16">
            <p className="section-label mb-6">Comment ça se passe</p>
            <ol className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-6" style={{ listStyle: 'none', margin: 0, padding: 0 }}>
